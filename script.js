...
// ===== SCROLL REVEAL =====
const revealElements = document.querySelectorAll('.servicio-card, .proyecto-card, .feature, .contacto-item');
...
function showNotification(message, type = 'success') {
    ...
    notification.querySelector('i').style.color = type === 'success' ? 'var(--whatsapp)' : '#dc3545';
